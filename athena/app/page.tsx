                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                  {projects.map((project, index) => (
                    <motion.button
                      ...
                      onClick={() =>
                        router.push(
                          `/organizations/${project.organizationId}/projects/${project._id}`,
                        )
                      }
                      className="bg-card border border-border rounded-xl p-4 sm:p-6 hover:shadow-lg transition-all text-left group"
                    >
                      <div className="flex items-start gap-3 sm:gap-4">
                        {project.image ? (
                          ...
                          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-linear-to-br from-primary to-purple-600 flex items-center justify-center shadow-sm shrink-0">
